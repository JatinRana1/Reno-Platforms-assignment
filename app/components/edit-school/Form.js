...
import { GraduationCap, MapPin, Phone, Mail, Upload, Building2 } from "lucide-react";

export default function EditSchoolForm({ schoolId }) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
            <div className="max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 mt-2">Update the details of the school</p>
                </div>
                ...
                >
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        {errors.name && <p className="text-red-500 text-sm flex items-center">⚠️ Name is required</p>}
                    </div>
